...
- [2 2. Map the Region](#2._Map_the_Region)
- [3 3. Locate Human Realms](#3._Locate_Human_Realms)
- [4 4. Locate Non-Human Realms](#4._Locate_Non-Human_Realms)
- [5 5. Place the Base Town](#5._Place_the_Base_Town)
- [6 6. Place Dungeons](#6._Place_Dungeons)
- [7 7. Create Regional Encounter Tables](#7._Create_Regional_Encounter_Tables)
...
**[Nomads](/srd/index.php/Nomad "Nomad"):** Some intelligent species may keep domains with well-defined boundaries while others may move around—hunting or raiding—within a more vaguely defined area.
...
Locate a base town for player characters on the map, typically close to a river or road near the centre of the map. This is where play will begin. The guidelines in ***[Designing a Base Town](/srd/index.php/Designing_a_Base_Town "Designing a Base Town")*** may be used to help flesh out the base town.

## 6. Place Dungeons

Place one or more [dungeons](/srd/index.php/Designing_a_Dungeon "Designing a Dungeon") on the map, somewhere in the vicinity of the base town.
...
**Standard tables:** The standard encounter tables (see ***[Wilderness Encounters](/srd/index.php/Wilderness_Encounters "Wilderness Encounters")***) may be suited to some areas of the campaign map.

**Custom tables:** For other areas, the [referee](/srd/index.php/The_Referee%E2%80%99s_Role "The Referee’s Role") may prefer to create new tables, with a selection of monsters customised to the area. Special encounter tables should take account of the intelligent and monstrous species marked on the map.
