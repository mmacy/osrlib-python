...
- **Charming gaze:** **Save versus spells at -2** or be charmed: move towards the vampire (resisting those who try to prevent it); defend the vampire; obey the vampire’s commands (if understood); unable to cast [spells](/srd/index.php/Spells "Spells") or use [magic items](/srd/index.php/Magic_Items_(General) "Magic Items (General)"); unable to harm the vampire. Killing the vampire breaks the charm.
...
- **Summon beasts:** In human form only. Creatures from the surrounding area: 1d10 × 10 [rats](/srd/index.php/Rat,_Normal "Rat, Normal"), 5d4 [giant rats](/srd/index.php/Rat,_Giant "Rat, Giant"), 1d10 × 10 [bats](/srd/index.php/Bat,_Normal "Bat, Normal"), 3d6 [giant bats](/srd/index.php/Bat,_Giant "Bat, Giant"), 3d6 [wolves](/srd/index.php/Wolf,_Normal "Wolf, Normal"), or 2d4 [dire wolves](/srd/index.php/Wolf,_Dire "Wolf, Dire").
