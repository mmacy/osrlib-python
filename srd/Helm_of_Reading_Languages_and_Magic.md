...
- **Normal text:** Text in any [language](/srd/index.php/Languages "Languages") can be understood.
- **Magical text:** Even magical writing is comprehensible. (This does not grant the ability to cast [spells](/srd/index.php/Spells "Spells"), however.)
