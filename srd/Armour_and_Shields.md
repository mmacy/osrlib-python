...
**Weight:** If using the optional rules for detailed encumbrance (see ***[Encumbrance](/srd/index.php/Time,_Weight,_Movement#Encumbrance_.28Optional_Rule.29 "Time, Weight, Movement")***), the enchanted armour’s encumbrance value is 50% less than that of normal armour.

## Type of Armour

The [referee](/srd/index.php/The_Referee%E2%80%99s_Role "The Referee’s Role") may choose the type of armour in a treasure hoard, or may roll on the following table:
