...
Multitudinous, disease-ridden rodents that will eat anything. Avoid contact with humans, but may attack if defending their nest or if summoned and commanded by magic (e.g. see [Wererat](/srd/index.php/Wererat "Wererat")).
...
- [1 Giant Rat](#Giant_Rat)
- [2 Normal Rat](#Normal_Rat)

## Giant Rat

3’ long (or larger), with black or grey fur. Often live in dark, dungeon areas and close to [undead](/srd/index.php/Category:Undead "Category:Undead") monsters.
