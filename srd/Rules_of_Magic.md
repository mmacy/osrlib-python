...
Some [character classes](/srd/index.php/Character_Classes "Character Classes") have the ability to memorize and cast magical spells. A spell consists of a pattern of magical energy memorized in a character’s mind. When a spell is cast, the spell is erased from the character’s mind until it is memorized again.

**Arcane and divine magic:** Spells are either granted by a deity or higher power (***[#divine magic](#Divine_Magic)***) or learned by esoteric study (***[#arcane magic](#Arcane_Magic)***). The differences between the two types of magic are described opposite.
...
- [1 Memorizing Spells](#Memorizing_Spells)
- [2 Casting Spells](#Casting_Spells)
- [3 Spell Effects](#Spell_Effects)
- [4 Arcane Magic](#Arcane_Magic)
  - [4.1 Memorizing Spells](#Memorizing_Spells_2)
  - [4.2 Reversing Spells](#Reversing_Spells)
- [5 Divine Magic](#Divine_Magic)
  - [5.1 Memorizing Spells](#Memorizing_Spells_3)
  - [5.2 Reversing Spells](#Reversing_Spells_2)
  - [5.3 Deity Disfavour](#Deity_Disfavour)
  - [5.4 Spells and Deity Alignment](#Spells_and_Deity_Alignment)
...
**Selecting targets:** Some spells affect multiple targets, either by area or by Hit Dice total. If the spell description does not specify how targets are selected, the [referee](/srd/index.php/The_Referee%E2%80%99s_Role "The Referee’s Role") must decide whether they are selected randomly, by the caster, etc.
...
**Cumulative effects:** Certain spells grant bonuses (or penalties) to game statistics such as attack rolls, AC, damage rolls, [saving throws](/srd/index.php/Saving_Throws "Saving Throws"), movement rate, attacks per round, etc. Multiple spells affecting the same game statistic do not combine. Spell effects can combine with [magical items](/srd/index.php/Magic_Items_(General) "Magic Items (General)") effects, however.

## Arcane Magic

### Memorizing Spells

Arcane spell casters memorize spells by studying spell books (see ***[Spell Books](/srd/index.php/Spell_Books "Spell Books")***) and are thus limited to choosing from the spells in their spell book, which must be at hand.
...
*Note: entry included from [Spells](/srd/index.php/Spells "Spells")*.
