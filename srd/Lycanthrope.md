...
- **Mundane damage immunity:** In animal form, can only harmed by [silver weapons](/srd/index.php/Other_Combat_Issues#Invulnerabilities_.28Optional_Rule.29 "Other Combat Issues") or magic.
...
- **Summon animals:** Can summon 1–2 animals of the associated type from the surrounding area (wererats summon [giant rats](/srd/index.php/Rat,_Giant "Rat, Giant")). These arrive in 1d4 rounds.
- **Wolfsbane:** If hit, must save versus poison or flee in terror.
- **Reversion:** If killed, a lycanthrope reverts to its human form.
- **Scent:** [Horses](/srd/index.php/Horse "Horse") and some other animals can smell lycanthropes and will become afraid.
- **Infection:** A character who loses more than ½ their hit points from lycanthropes’ natural attacks (i.e. bites, claws) contracts lycanthropy. Humans become were-creatures of the same type (run by the [referee](/srd/index.php/The_Referee%E2%80%99s_Role "The Referee’s Role"), henceforth); non-humans die. The disease takes full effect in 2d12 days, showing signs of infection after half the time.


## Contents

- [1 Devil Swine](#Devil_Swine)
- [2 Werebear](#Werebear)
- [3 Wereboar](#Wereboar)
- [4 Wererat](#Wererat)
- [5 Weretiger](#Weretiger)
- [6 Werewolf](#Werewolf)
...
- **Charm person:** 3 times a day. **Save versus spells at -2** or be charmed: move towards the devil swine (resisting those who try to prevent it); obey the devil swine’s commands (if understood); defend the devil swine; unable to cast [spells](/srd/index.php/Spells "Spells") or use [magic items](/srd/index.php/Magic_Items_(General) "Magic Items (General)"); unable to harm the devil swine. Killing the devil swine breaks the charm.
- **Charmed victims:** 1d4-1 accompany a devil swine.


## Werebear

Highly intelligent, also in bear form. Dwell alone or among normal [bears](/srd/index.php/Bear "Bear").
...
Semi-intelligent and irascible. In human form, often appear like [berserkers](/srd/index.php/Berserker "Berserker").
...
Intelligent, humanoid [rats](/srd/index.php/Rat "Rat") who can change into normal humans.
