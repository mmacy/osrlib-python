...
When PCs wander into the vicinity of the wilderness stronghold of a high-level NPC, a warm reception is not always guaranteed. These guidelines may be used if the [referee](/srd/index.php/The_Referee%E2%80%99s_Role "The Referee’s Role") does not have specific notes on a stronghold’s ruler and guard patrols.
...
- [2 Patrols](#Patrols)
- [3 Garrison](#Garrison)
- [4 Reaction to Travellers](#Reaction_to_Travellers)
...
Strangers in the lands around a stronghold will typically be spotted by [mercenary](/srd/index.php/Mercenaries "Mercenaries") groups hired to patrol the lands. The type of troops depends on the ruler’s class:
