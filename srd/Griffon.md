...
Large, rapacious predators combining the features of an eagle (head, wings, front claws) and a lion. Prey on [horses](/srd/index.php/Horse "Horse").
...
- **Attack horses:** Within 120’, unless a [morale check](/srd/index.php/Morale_(Optional_Rule) "Morale (Optional Rule)") is passed.
