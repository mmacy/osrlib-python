...
- [1 Sequence of Play Per Day](#Sequence_of_Play_Per_Day)
- [2 Distance and Measurement](#Distance_and_Measurement)
- [3 Flying](#Flying)
  - [3.1 Flying Mounts](#Flying_Mounts)
- [4 Foraging](#Foraging)
- [5 Hunting](#Hunting)
- [6 Losing Direction](#Losing_Direction)
- [7 Overland Travel](#Overland_Travel)
  - [7.1 Terrain Modifiers](#Terrain_Modifiers)
  - [7.2 Forced March](#Forced_March)
- [8 Resting](#Resting)
- [9 Surprise](#Surprise)
- [10 Visibility](#Visibility)
- [11 Wandering Monsters](#Wandering_Monsters)
  - [11.1 Chance by Terrain](#Chance_by_Terrain)
...
4. **Description:** The referee describes the terrain passed through and any sites of interest that the party comes across, asking players for their actions, as required. If monsters are encountered, follow the procedure described in ***[Encounters](/srd/index.php/Encounters "Encounters")***.
...
**Miles per day:** The distance a creature can fly in a day is double the distance it can travel overland (see ***[#Overland Travel](#Overland_Travel)***). For example, a creature with a movement rate of 120’ could travel 24 miles in a day overland, but could fly 48 miles in a day.
...
Foraging for herbs, fruits, nuts, etc. can be performed alongside normal movement (see ***[#Overland Travel](#Overland_Travel)***). The party has a 1-in-6 chance per day of finding enough food for 1d6 human-sized beings.

## Hunting

Hunting animals takes up a complete day, with no travelling or resting possible. When hunting, there is a 1-in-6 chance of encountering animals which may be suitable for eating (if they can be caught!). This is in addition to the normal chance of random encounters (see ***[#Wandering Monsters](#Wandering_Monsters)***).

## Losing Direction

At the start of each day of travel, the [referee](/srd/index.php/The_Referee%E2%80%99s_Role "The Referee’s Role") should roll to determine if the group loses direction. The probability depends on the terrain being traversed:
...
**Effects:** See ***[Losing Direction](/srd/index.php/Hazards_and_Challenges#Losing_Direction "Hazards and Challenges")***.
...
**Surrounded:** If a party is [surprised](/srd/index.php/Encounters "Encounters") by three or more monsters, the monsters may have moved to encircle the party.
...
**Distance:** Wandering monsters are encountered 4d6 × 10 yards away. If either side is surprised (see ***[Encounters](/srd/index.php/Encounters "Encounters")***), this is reduced to 1d4 × 10 yards.
