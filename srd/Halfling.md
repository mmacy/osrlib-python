...
- [1 Combat](#Combat)
- [2 Defensive Bonus](#Defensive_Bonus)
- [3 Hiding](#Hiding)
- [4 Initiative Bonus (Optional Rule)](#Initiative_Bonus_.28Optional_Rule.29)
- [5 Listening at Doors](#Listening_at_Doors)
- [6 Missile Attack Bonus](#Missile_Attack_Bonus)
- [7 Stronghold](#Stronghold)
- [8 Halfling Level Progression](#Halfling_Level_Progression)

## Combat

Halflings can use all types of armour, but it must be tailored to their small size. Similarly, they can use any weapon appropriate to their stature (as determined by the [referee](/srd/index.php/The_Referee%E2%80%99s_Role "The Referee’s Role")). They cannot use longbows or two-handed swords.
...
If using the optional rule for individual initiative (see ***[Combat](/srd/index.php/Combat "Combat")***), halflings get a bonus of +1 to initiative rolls.

## Listening at Doors

Halflings have a 2-in-6 chance of hearing noises (see ***[Dungeon Adventuring](/srd/index.php/Dungeon_Adventuring "Dungeon Adventuring")***).
