...
**Size:** The ideal size of a group is between 6 and 8 characters—large enough to confront the challenges of the adventure, while not so large as to be disorganised. If not enough PCs are present, the players may wish to hire retainers (see *[Retainers](/srd/index.php/Retainers "Retainers")*).
...
- [1 Marching Order](#Marching_Order)
- [2 The Caller](#The_Caller)
- [3 The Mapper](#The_Mapper)
- [4 Dividing Treasure](#Dividing_Treasure)
...
If the players wish to, they may nominate one of their number as the spokesperson of the group, known as the caller. This player is responsible for informing the [referee](/srd/index.php/The_Referee%E2%80%99s_Role "The Referee’s Role") about the actions and movements of the party as a whole. Delegating this role to one player—rather than having each player informing the referee about their PC’s individual actions—can speed up play.
