...
- **Affected creatures:** Are afflicted by the drums’ enchantment of fear: they must **save versus spells** or make a [morale check](/srd/index.php/Morale_(Optional_Rule) "Morale (Optional Rule)") with a -2 penalty (if the optional morale rules are being used—see ***[Morale](/srd/index.php/Morale_(Optional_Rule) "Morale (Optional Rule)")***).
