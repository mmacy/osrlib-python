...
- [1 1. Choose the Setting](#1._Choose_the_Setting)
- [2 2. Choose Monsters](#2._Choose_Monsters)
- [3 3. Map the Dungeon](#3._Map_the_Dungeon)
- [4 4. Stock the Dungeon](#4._Stock_the_Dungeon)
  - [4.1 Dungeon Levels](#Dungeon_Levels)
  - [4.2 Danger and Reward](#Danger_and_Reward)
  - [4.3 Unguarded Treasure](#Unguarded_Treasure)
- [5 Random Room Stocking](#Random_Room_Stocking)
  - [5.1 Example Room Traps](#Example_Room_Traps)
  - [5.2 Example Treasure Traps](#Example_Treasure_Traps)
  - [5.3 Example Specials](#Example_Specials)
  - [5.4 Treasure in Empty / Trapped Rooms](#Treasure_in_Empty_.2F_Trapped_Rooms)
...
Based on the selected [adventure scenario](/srd/index.php/Adventure_Scenarios "Adventure Scenarios") and dungeon setting, decide what types of monsters inhabit the dungeon, choosing from any monster books that are available, creating new monsters specially for the dungeon, or tailoring standard monsters to the location.
...
**Experienced players:** When designing dungeons for experienced players, the [referee](/srd/index.php/The_Referee%E2%80%99s_Role "The Referee’s Role") should consider placing only very few completely unguarded treasures.
...
**Monsters:** May be selected by hand or rolled on an [encounter table](/srd/index.php/Dungeon_Encounters "Dungeon Encounters").
...
4. **Pit:** Opens up beneath characters’ feet, inflicting falling damage on any who fall in (see ***[Falling](/srd/index.php/Hazards_and_Challenges#Falling "Hazards and Challenges")***).
...
3. **Hidden monster:** e.g. a [snake](/srd/index.php/Snake "Snake"). Released when the treasure is disturbed.
...
5. **Spray:** A mysterious liquid covers the character. Monsters are attracted to the smell: the chance of [wandering monsters](/srd/index.php/Hazards_and_Challenges#Wandering_Monsters "Hazards and Challenges") is doubled for 1d6 hours.
