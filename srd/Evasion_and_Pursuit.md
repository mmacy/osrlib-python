...
- [1 In the Dungeon](#In_the_Dungeon)
  - [1.1 Evasion](#Evasion)
  - [1.2 Pursuit](#Pursuit)
  - [1.3 Running](#Running)
- [2 Waterborne](#Waterborne)
  - [2.1 Evasion](#Evasion_2)
  - [2.2 Pursuit](#Pursuit_2)
- [3 In the Wilderness](#In_the_Wilderness)
  - [3.1 Evasion](#Evasion_3)
  - [3.2 Evasion Modifiers](#Evasion_Modifiers)
  - [3.3 Pursuit](#Pursuit_3)
...
**Time:** Is measured in rounds (see ***[Time, Weight, Movement](/srd/index.php/Time,_Weight,_Movement "Time, Weight, Movement")***).
...
**Initial distance:** The two sides begin a pursuit at normal encounter distance (see [Waterborne Adventuring](/srd/index.php/Waterborne_Adventuring "Waterborne Adventuring")).
...
The chance of evasion is a percentile roll. If the percentile evasion roll fails, a pursuit occurs. Surprise (see ***[Encounters](/srd/index.php/Encounters "Encounters")***) determines the chance of evasion:
...
- **Surprised side:** May generally not evade. The [referee](/srd/index.php/The_Referee%E2%80%99s_Role "The Referee’s Role") may rule that environmental conditions give a small chance of evasion even when surprised (as above). For example, dense woodland may give a surprised side a 10% chance of evasion.
