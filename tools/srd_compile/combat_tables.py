...
Three tables: the attack matrix (16 THAC0 rows from `20 [-1]`/NH to `5 [+14]`, AC
columns −3..9, with the monster-HD row labels), the monster saving-throw bands (NH,
1–3, ... 22 or more), and the XP-awards-for-defeated-monsters table including the
separate `N+` rows for bonus hit-point modifiers. The matrix's AC-0 column is printed
bold — data, stripped here.
"""
...
SOURCE_PAGES = ("Combat_Tables.md", "Awarding_XP.md")
